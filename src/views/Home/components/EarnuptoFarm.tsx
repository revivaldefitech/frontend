    ...
    (farmsToDisplay) => {
      ...
      farmsToDisplay.map((farm) => {
        if(!farm.isTokenOnly){
          ...
          const { cakeRewardsApr } = getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.vivalperblock))
          apy = cakeRewardsApr
