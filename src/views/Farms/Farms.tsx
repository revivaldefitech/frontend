    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.vivalperblock))
    ...
    <>
            ...
            <Flex flexDirection="column" flex="1" alignSelf={['flex-start', null, null, 'center']}>
              ...
              <Flex>
                <Heading scale="lg" color="primary">
                  {tokenMode ? t('Stake Single token to earn VIV') : t('Stake LP tokens to earn VIV')}
                </Heading>
              </Flex>
            </Flex>
      ...
      <Page>
        <ControlContainer>
          ...
          <FilterContainer>
            <LabelWrapper>
              <Text textTransform="uppercase" color="primary">{t('Sort by')}</Text>
              <Select
                options={[
                  {
                    label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text textTransform="uppercase" color="primary">{t('Search')}</Text>
