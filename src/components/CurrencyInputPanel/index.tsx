    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <Text fontSize="14px" color="#455db1">{translatedLabel}</Text>
              {account && (
                <Text onClick={onMax} fontSize="14px" color="#455db1" style={{ display: 'inline', cursor: 'pointer' }}>
